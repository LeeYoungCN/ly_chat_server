...
std::string time_string()
{
    ...
    auto timestamp = get_now_time_stamp_ms();
...
void DebugLoggerInner::log_va(const char* file, int line, const char* func, DebugLevel level,
                              const char* format, va_list args)
{
    log_it(level, va_list_to_string(format, args), file, line, func);
}

void DebugLoggerInner::log_it(DebugLevel level, const std::string& message, const char* file,
...
bool DebugLoggerInner::should_log(DebugLevel level)
{
    return (_logLevel != DebugLevel::DEBUG_LVL_OFF && level >= _logLevel);
}

std::string DebugLoggerInner::format_log(DebugLevel level, const std::string& message,
...
std::string DebugLoggerInner::va_list_to_string(const char* format, va_list args)
{
    va_list argsCopy;
