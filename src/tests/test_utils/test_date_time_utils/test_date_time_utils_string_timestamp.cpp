...
TEST_P(TestDateTimeUtilsTimestampBuffer, TimestampMs)
{
    ...
    TimestampMs const currTs = utils::date_time::get_current_time_stamp_ms() + day * MILLIS_PER_DAY;
...
TEST_P(TestDateTimeUtilsTimestampStr, TimestampMs)
{
    ...
    TimestampMs const currTs = utils::date_time::get_current_time_stamp_ms();
